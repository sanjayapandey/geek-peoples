...
import com.lftechnology.geekpeoples.guestportlet.model.QuestionClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"Guest-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "Guest-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.lftechnology.geekpeoples.guestportlet.model.impl.QuestionImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.lftechnology.geekpeoples.guestportlet.NoSuchQuestionException")) {
			return new com.lftechnology.geekpeoples.guestportlet.NoSuchQuestionException();
		}
